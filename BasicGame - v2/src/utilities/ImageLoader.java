...
public final class ImageLoader {
	...
	private ImageIcon doorClosedImg;
	...
	private void loadImages() {
		try {
			...
			doorClosedImg = new ImageIcon(ImageIO.read(new File("Images/closed40.png")));
	...
	public final ImageIcon getDoorClosedImg() {
		return doorClosedImg;
	}
