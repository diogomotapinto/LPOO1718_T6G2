...
final class GameWindow extends JFrame {
	...
	private JMenuItem restoreSavedGameMI;
	...
	private void initializeWindow() {
		...
		JMenuItem saveGameMI = new JMenuItem("Save Game");
		initializeSaveGame(saveGameMI);
		menuMn.add(saveGameMI);
		
		restoreSavedGameMI = new JMenuItem("Restore Saved Game");
		restoreSavedGameMI.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Serialization ser = new Serialization(); 
				ser.deSerialize(); 
			}
		});
		menuMn.add(restoreSavedGameMI);
